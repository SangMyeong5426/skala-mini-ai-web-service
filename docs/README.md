...
| DB 테이블·컬럼 | 기존 10개 테이블·관계 유지. 목표 ERD에 users.login_id 추가, SQL·시드·DB 미반영. 후보·채택 연결은 기존 JSON 필드 사용 |
| 다이어그램 | 4종 PNG·PUML·SVG를 로그인 포함 목표 설계로 재생성. S-00 진입·인증/소유권·로그인 아이디와 기존 승인·추천 흐름 반영 |
