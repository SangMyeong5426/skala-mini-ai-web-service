...
- [x] 화면 구현 2차 — `S-07` 무게 상세 · `S-08` 반입 규정 상세 · `S-11` 여행 일정 (#53)
- [x] 화면 구현 3차 일부 — `S-09` 챗봇
- [x] 화면 구현 3차 잔여 — `S-10` 여행 기록 상세 · `S-12` 3D 가방 정리 (#53)
- [x] **화면 11개 전체 구현 완료** — `S-00`~`S-12`. 남은 것은 진입 경로 둘뿐이다 — `S-07` 은 보류(TBD), `S-08` 은 챗봇이 대신한다 (03:55)
