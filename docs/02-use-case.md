...
> **2026-09-03 PNG·PUML·SVG 개정 반영.** UC-05 추가 추천·선택 채택, UC-04 사진 승인 등록과
> UC-06 실제 준비 상태를 아래 표와 맞췄다. 기능 ID를 유지하고 제외한 로그인의 Actor 연결은 제거했다.
...
두 페이지에 반영됐다는 확인으로 확대하지 않는다. 이번 PR은 개인 개정안의 축약 페르소나보다
