...
| 주요 요소 | **필수** 이동수단·항공사·출발/도착 공항·출발일·귀국일·목적<br>**자동** 출발지·도착지 — 공항에서 나온 값이라 고칠 수 없다. 날씨·추천이 이 도시로 돌아간다<br>**선택** 경유지·숙소·가방 크기·동행인·개인 특이사항. 경유지·숙소·동행인의 개별 API·저장 규약은 TBD |
