...
> Notion 3절과 페르소나 1·3 이용 흐름도 이 순서로 맞췄다 (2026-09-03).
...
| 호출 API | `POST /api/ai-jobs` (`PACKING_LIST`, **승인 물품 포함**) → `202`<br>`GET /api/ai-jobs/{jobId}` → `200` **폴링**<br>`GET` / `POST` / `PATCH` / `DELETE /api/trips/{tripId}/items` |
