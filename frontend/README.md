...
> ⚠️ 과정 자료(PDF 8쪽)의 프런트엔드 스택 목록에는 **Vue.js와 HTML/CSS/JS만**
> 있다. React 사용 가능 여부를 **1일차에 교수님께 확인한다.** 불가하면 Vue로
> 되돌린다 — 화면이 1~2개뿐이라 되돌리는 비용은 낮지만 **2일차 전에** 판단해야
> 한다. 자세한 내용은 ADR 0002의 "이 결정이 지는 위험".
